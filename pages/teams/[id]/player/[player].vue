...
const { fetchPlayer } = useHockeyApi();
...
<template>
  <main>
    ...
    <Head>
      <Script defer data-domain="rotorink.com" src="https://plausible.io/js/plausible.js" />
    </Head>
    <section>
      <div v-if="player"
        ...
        <div class="p-4 md:p-5">
            ...
            <div class="mr-2">
              ...
              <template v-if="currentSeasonStats">
                ...
                <p class="mt-4 mb-4 font-bold text-white">
                  SPG:
                  <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">{{
          ...
          <button v-if="isLiked" @click="unlikePlayer(userLike.id)"
          ...
          <button v-else type="button" @click="likePlayer"
