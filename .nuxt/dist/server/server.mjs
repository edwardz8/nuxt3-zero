...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<main${__vite_ssr_import_8__.ssrRenderAttrs(_attrs)}><header class="page-heading"><div class="wrapper"><h1 class="text-5xl font-extrabold">All articles</h1><p class="font-medium text-lg">List of all articles</p></div></header><section class="page-section">`)
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(`<main${__vite_ssr_import_2__.ssrRenderAttrs(_attrs)} data-v-2a183b29><section class="hero-section" data-v-2a183b29><header data-v-2a183b29><h1 class="font-black text-6xl" data-v-2a183b29>Welcome to rosterbox</h1><span class="text-4xl" data-v-2a183b29>🏈 🏒 ⚽</span><p data-v-2a183b29>browse the`)
  _push(__vite_ssr_import_2__.ssrRenderComponent(_component_NuxtLink, { to: "/blog" }, {
    default: __vite_ssr_import_1__.withCtx((_, _push, _parent, _scopeId) => {
      if (_push) {
        _push(` fantasy sports articles`)
      } else {
        return [
          __vite_ssr_import_1__.createTextVNode(" fantasy sports articles")
        ]
      }
    }),
    _: 1 /* STABLE */
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_1__.default(_sfc_main, [['__file',"/Users/edwardz_8/vue-projects/nuxt3-zero/pages/login.vue"]])
const meta = undefined
Object.defineProperty(__vite_ssr_exports__, "meta", { enumerable: true, configurable: true, get(){ return meta }});;
}
...
__vite_ssr_exports__.default = /*#__PURE__*/__vite_ssr_import_1__.default(_sfc_main, [['__file',"/Users/edwardz_8/vue-projects/nuxt3-zero/pages/register.vue"]])
const meta = undefined
Object.defineProperty(__vite_ssr_exports__, "meta", { enumerable: true, configurable: true, get(){ return meta }});;
}
      ...
      if (_push) {
        ...
        return [
          __vite_ssr_import_1__.createVNode("figure", { class: "site-logo" }, [
            __vite_ssr_import_1__.createVNode("h1", null, "Site")
          ])
        ]
      }
    }),
