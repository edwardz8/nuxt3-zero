...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_Script = resolveComponent("Script");
  const _component_NuxtLink = __nuxt_component_0$4;
  _push(`<main${ssrRenderAttrs(_attrs)} data-v-66bde040>`);
  _push(ssrRenderComponent(_component_Head, null, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Script, {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/blog" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode(" daily fantasy hockey and props content")
        ];
      }
    }),
    _: 1
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/teams" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createTextVNode("like and comment on your favorite players for the day")
        ];
      }
    }),
    _: 1
