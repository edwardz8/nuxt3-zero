...
const meta$5 = void 0;
const Tags_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "\n/* ... */\n.tag-list[data-v-55a8f4e7] {\n    display: flex;\n    align-items: center;\n    gap: 0.5rem;\n    border-radius: 0.5rem;\n    border-width: 1px;\n    border-color: transparent;\n    padding: 0.5rem\n}\n.tag-list.active[data-v-55a8f4e7] {\n    --tw-border-opacity: 1;\n    border-color: rgb(226 232 240 / var(--tw-border-opacity))\n}\n.article-tags[data-v-55a8f4e7] {\n    max-width: 0rem;\n    overflow: hidden;\n    transition-property: all;\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n    transition-duration: 150ms\n}\n.article-tags.expanded[data-v-55a8f4e7] {\n    max-width: 100%\n}\n")();
const _sfc_main$C = {
  __name: "Tags",
  __ssrInlineRender: true,
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span data-v-55a8f4e7>Tags</span></button><ul class="${ssrRenderClass([{ expanded: expanded.value }, "article-tags"])}" data-v-55a8f4e7><!--[-->`);
...
const InfoBox_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "\n.info-box[data-v-6963ff7a] {\n\n    display: flex;\n\n    align-items: flex-start;\n\n    gap: 0.5rem;\n\n    border-radius: 0.5rem;\n\n    border-width: 1px;\n\n    --tw-border-opacity: 1;\n\n    border-color: rgb(226 232 240 / var(--tw-border-opacity));\n\n    --tw-bg-opacity: 1;\n\n    background-color: rgb(241 245 249 / var(--tw-bg-opacity));\n\n    padding: 1rem;\n\n    --tw-text-opacity: 1;\n\n    color: rgb(100 116 139 / var(--tw-text-opacity))\n}\ndetails summary[data-v-6963ff7a] {\n\n    display: flex;\n\n    cursor: pointer;\n\n    font-weight: 600;\n\n    line-height: 1.25\n}\ndetails .details[data-v-6963ff7a] {\n\n    font-size: 0.875rem;\n\n    line-height: 1.25rem\n}\n.info-box .icon[data-v-6963ff7a] {\n\n    flex-shrink: 0\n}\n.info-box.warning[data-v-6963ff7a] {\n\n    --tw-border-opacity: 1;\n\n    border-color: rgb(250 204 21 / var(--tw-border-opacity));\n\n    --tw-bg-opacity: 1;\n\n    background-color: rgb(254 240 138 / var(--tw-bg-opacity));\n\n    --tw-text-opacity: 1;\n\n    color: rgb(202 138 4 / var(--tw-text-opacity))\n}\n.info-box.warning .icon.solid[data-v-6963ff7a] {\n\n    fill: #ca8a04\n}\n.info-box.error[data-v-6963ff7a] {\n\n    --tw-border-opacity: 1;\n\n    border-color: rgb(248 113 113 / var(--tw-border-opacity));\n\n    --tw-bg-opacity: 1;\n\n    background-color: rgb(254 202 202 / var(--tw-bg-opacity));\n\n    --tw-text-opacity: 1;\n\n    color: rgb(220 38 38 / var(--tw-text-opacity))\n}\n.info-box.error .icon.solid[data-v-6963ff7a] {\n\n    fill: #dc2626\n}\n")();
const _sfc_main$u = {
  __name: "InfoBox",
  __ssrInlineRender: true,
  props: ["type"],
