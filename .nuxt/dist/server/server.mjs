...
function _sfc_ssrRender$k(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/teams" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createVNode("button", { class: "rounded-md shadow w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-500 hover:bg-blue-500" }, " Player Stats ")
        ];
      }
    }),
    _: 1
  ...
  _push(`</div></div></main></div><div class="container mx-auto flex flex-col items-center"><div class="w-full"><img${ssrRenderAttr("src", _imports_0$1)} alt=""></div></div></div>`);
}
...
const _sfc_main$M = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen" }, _attrs))}><div class="flex items-center justify-center px-4 sm:px-6 lg:px-8"><div class="max-w-md w-full"><div class="flex"><img class="mx-auto h-24 w-auto"${ssrRenderAttr("src", _imports_0$1)} alt="rotorink logo"><h1 class="py-9 text-center text-3xl font-extrabold text-gray-900"> rotorink </h1></div><div><h2 class="text-center text-3xl font-extrabold mt-5 text-gray-900">Sign Up</h2></div>`);
