...
const ____slug__vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => '\n.article-main[data-v-0d3e7b2a] {\n\n    margin: auto;\n\n    max-width: 64rem;\n\n    padding: 1rem;\n}\n.article-header[data-v-0d3e7b2a] {\n\n    padding: 1rem;\n\n    padding-bottom: 3rem;\n}\n.article-header .heading[data-v-0d3e7b2a] {\n\n    font-size: 3rem;\n\n    line-height: 1;\n\n    font-weight: 800;\n}\n.article-header .supporting[data-v-0d3e7b2a] {\n\n    font-size: 1.125rem;\n\n    line-height: 1.75rem;\n\n    font-weight: 500;\n}\n.article-section[data-v-0d3e7b2a] {\n\n    display: grid;\n\n    grid-template-columns: repeat(8, minmax(0, 1fr));\n}\n.aside[data-v-0d3e7b2a] {\n\n    grid-column: 1 / -1;\n\n    grid-row-start: 1;\n\n    width: 100%;\n\n    padding-top: 3.5rem;\n}\n@media (min-width: 768px) {\n.aside[data-v-0d3e7b2a] {\n\n        grid-column: span 2 / span 2;\n}\n}\n.aside .toc[data-v-0d3e7b2a] {\n\n    position: -webkit-sticky;\n\n    position: sticky;\n\n    top: 5rem;\n}\n.article[data-v-0d3e7b2a] {\n\n    color: var(--tw-prose-body);\n\n    max-width: 65ch;\n}\n.article[data-v-0d3e7b2a] :where([class~="lead"]):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-lead);\n\n    font-size: 1.25em;\n\n    line-height: 1.6;\n\n    margin-top: 1.2em;\n\n    margin-bottom: 1.2em;\n}\n.article[data-v-0d3e7b2a] :where(a):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-links);\n\n    text-decoration: underline;\n\n    font-weight: 500;\n}\n.article[data-v-0d3e7b2a] :where(strong):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-bold);\n\n    font-weight: 600;\n}\n.article[data-v-0d3e7b2a] :where(ol):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: decimal;\n\n    padding-left: 1.625em;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="A"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-alpha;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="a"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-alpha;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="A" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-alpha;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="a" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-alpha;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="I"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-roman;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="i"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-roman;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="I" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: upper-roman;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="i" s]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: lower-roman;\n}\n.article[data-v-0d3e7b2a] :where(ol[type="1"]):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: decimal;\n}\n.article[data-v-0d3e7b2a] :where(ul):not(:where([class~="not-prose"] *)) {\n\n    list-style-type: disc;\n\n    padding-left: 1.625em;\n}\n.article[data-v-0d3e7b2a] :where(ol > li):not(:where([class~="not-prose"] *))::marker {\n\n    font-weight: 400;\n\n    color: var(--tw-prose-counters);\n}\n.article[data-v-0d3e7b2a] :where(ul > li):not(:where([class~="not-prose"] *))::marker {\n\n    color: var(--tw-prose-bullets);\n}\n.article[data-v-0d3e7b2a] :where(hr):not(:where([class~="not-prose"] *)) {\n\n    border-color: var(--tw-prose-hr);\n\n    border-top-width: 1px;\n\n    margin-top: 3em;\n\n    margin-bottom: 3em;\n}\n.article[data-v-0d3e7b2a] :where(blockquote):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 500;\n\n    font-style: italic;\n\n    color: var(--tw-prose-quotes);\n\n    border-left-width: 0.25rem;\n\n    border-left-color: var(--tw-prose-quote-borders);\n\n    quotes: "\\201C""\\201D""\\2018""\\2019";\n\n    margin-top: 1.6em;\n\n    margin-bottom: 1.6em;\n\n    padding-left: 1em;\n}\n.article[data-v-0d3e7b2a] :where(blockquote p:first-of-type):not(:where([class~="not-prose"] *))::before {\n\n    content: open-quote;\n}\n.article[data-v-0d3e7b2a] :where(blockquote p:last-of-type):not(:where([class~="not-prose"] *))::after {\n\n    content: close-quote;\n}\n.article[data-v-0d3e7b2a] :where(h1):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 800;\n\n    font-size: 2.25em;\n\n    margin-top: 0;\n\n    margin-bottom: 0.8888889em;\n\n    line-height: 1.1111111;\n}\n.article[data-v-0d3e7b2a] :where(h1 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 900;\n}\n.article[data-v-0d3e7b2a] :where(h2):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 700;\n\n    font-size: 1.5em;\n\n    margin-top: 2em;\n\n    margin-bottom: 1em;\n\n    line-height: 1.3333333;\n}\n.article[data-v-0d3e7b2a] :where(h2 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 800;\n}\n.article[data-v-0d3e7b2a] :where(h3):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 600;\n\n    font-size: 1.25em;\n\n    margin-top: 1.6em;\n\n    margin-bottom: 0.6em;\n\n    line-height: 1.6;\n}\n.article[data-v-0d3e7b2a] :where(h3 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 700;\n}\n.article[data-v-0d3e7b2a] :where(h4):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 600;\n\n    margin-top: 1.5em;\n\n    margin-bottom: 0.5em;\n\n    line-height: 1.5;\n}\n.article[data-v-0d3e7b2a] :where(h4 strong):not(:where([class~="not-prose"] *)) {\n\n    font-weight: 700;\n}\n.article[data-v-0d3e7b2a] :where(figure > *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n\n    margin-bottom: 0;\n}\n.article[data-v-0d3e7b2a] :where(figcaption):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-captions);\n\n    font-size: 0.875em;\n\n    line-height: 1.4285714;\n\n    margin-top: 0.8571429em;\n}\n.article[data-v-0d3e7b2a] :where(code):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-code);\n\n    font-weight: 600;\n\n    font-size: 0.875em;\n}\n.article[data-v-0d3e7b2a] :where(code):not(:where([class~="not-prose"] *))::before {\n\n    content: "`";\n}\n.article[data-v-0d3e7b2a] :where(code):not(:where([class~="not-prose"] *))::after {\n\n    content: "`";\n}\n.article[data-v-0d3e7b2a] :where(a code):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-links);\n}\n.article[data-v-0d3e7b2a] :where(pre):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-pre-code);\n\n    background-color: var(--tw-prose-pre-bg);\n\n    overflow-x: auto;\n\n    font-weight: 400;\n\n    font-size: 0.875em;\n\n    line-height: 1.7142857;\n\n    margin-top: 1.7142857em;\n\n    margin-bottom: 1.7142857em;\n\n    border-radius: 0.375rem;\n\n    padding-top: 0.8571429em;\n\n    padding-right: 1.1428571em;\n\n    padding-bottom: 0.8571429em;\n\n    padding-left: 1.1428571em;\n}\n.article[data-v-0d3e7b2a] :where(pre code):not(:where([class~="not-prose"] *)) {\n\n    background-color: transparent;\n\n    border-width: 0;\n\n    border-radius: 0;\n\n    padding: 0;\n\n    font-weight: inherit;\n\n    color: inherit;\n\n    font-size: inherit;\n\n    font-family: inherit;\n\n    line-height: inherit;\n}\n.article[data-v-0d3e7b2a] :where(pre code):not(:where([class~="not-prose"] *))::before {\n\n    content: none;\n}\n.article[data-v-0d3e7b2a] :where(pre code):not(:where([class~="not-prose"] *))::after {\n\n    content: none;\n}\n.article[data-v-0d3e7b2a] :where(table):not(:where([class~="not-prose"] *)) {\n\n    width: 100%;\n\n    table-layout: auto;\n\n    text-align: left;\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n\n    font-size: 0.875em;\n\n    line-height: 1.7142857;\n}\n.article[data-v-0d3e7b2a] :where(thead):not(:where([class~="not-prose"] *)) {\n\n    border-bottom-width: 1px;\n\n    border-bottom-color: var(--tw-prose-th-borders);\n}\n.article[data-v-0d3e7b2a] :where(thead th):not(:where([class~="not-prose"] *)) {\n\n    color: var(--tw-prose-headings);\n\n    font-weight: 600;\n\n    vertical-align: bottom;\n\n    padding-right: 0.5714286em;\n\n    padding-bottom: 0.5714286em;\n\n    padding-left: 0.5714286em;\n}\n.article[data-v-0d3e7b2a] :where(tbody tr):not(:where([class~="not-prose"] *)) {\n\n    border-bottom-width: 1px;\n\n    border-bottom-color: var(--tw-prose-td-borders);\n}\n.article[data-v-0d3e7b2a] :where(tbody tr:last-child):not(:where([class~="not-prose"] *)) {\n\n    border-bottom-width: 0;\n}\n.article[data-v-0d3e7b2a] :where(tbody td):not(:where([class~="not-prose"] *)) {\n\n    vertical-align: baseline;\n\n    padding-top: 0.5714286em;\n\n    padding-right: 0.5714286em;\n\n    padding-bottom: 0.5714286em;\n\n    padding-left: 0.5714286em;\n}\n.article[data-v-0d3e7b2a] {\n\n    --tw-prose-body: #374151;\n\n    --tw-prose-headings: #111827;\n\n    --tw-prose-lead: #4b5563;\n\n    --tw-prose-links: #111827;\n\n    --tw-prose-bold: #111827;\n\n    --tw-prose-counters: #6b7280;\n\n    --tw-prose-bullets: #d1d5db;\n\n    --tw-prose-hr: #e5e7eb;\n\n    --tw-prose-quotes: #111827;\n\n    --tw-prose-quote-borders: #e5e7eb;\n\n    --tw-prose-captions: #6b7280;\n\n    --tw-prose-code: #111827;\n\n    --tw-prose-pre-code: #e5e7eb;\n\n    --tw-prose-pre-bg: #1f2937;\n\n    --tw-prose-th-borders: #d1d5db;\n\n    --tw-prose-td-borders: #e5e7eb;\n\n    --tw-prose-invert-body: #d1d5db;\n\n    --tw-prose-invert-headings: #fff;\n\n    --tw-prose-invert-lead: #9ca3af;\n\n    --tw-prose-invert-links: #fff;\n\n    --tw-prose-invert-bold: #fff;\n\n    --tw-prose-invert-counters: #9ca3af;\n\n    --tw-prose-invert-bullets: #4b5563;\n\n    --tw-prose-invert-hr: #374151;\n\n    --tw-prose-invert-quotes: #f3f4f6;\n\n    --tw-prose-invert-quote-borders: #374151;\n\n    --tw-prose-invert-captions: #9ca3af;\n\n    --tw-prose-invert-code: #fff;\n\n    --tw-prose-invert-pre-code: #d1d5db;\n\n    --tw-prose-invert-pre-bg: rgb(0 0 0 / 50%);\n\n    --tw-prose-invert-th-borders: #4b5563;\n\n    --tw-prose-invert-td-borders: #374151;\n\n    font-size: 1rem;\n\n    line-height: 1.75;\n}\n.article[data-v-0d3e7b2a] :where(p):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 1.25em;\n\n    margin-bottom: 1.25em;\n}\n.article[data-v-0d3e7b2a] :where(img):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n}\n.article[data-v-0d3e7b2a] :where(video):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n}\n.article[data-v-0d3e7b2a] :where(figure):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 2em;\n\n    margin-bottom: 2em;\n}\n.article[data-v-0d3e7b2a] :where(h2 code):not(:where([class~="not-prose"] *)) {\n\n    font-size: 0.875em;\n}\n.article[data-v-0d3e7b2a] :where(h3 code):not(:where([class~="not-prose"] *)) {\n\n    font-size: 0.9em;\n}\n.article[data-v-0d3e7b2a] :where(li):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0.5em;\n\n    margin-bottom: 0.5em;\n}\n.article[data-v-0d3e7b2a] :where(ol > li):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0.375em;\n}\n.article[data-v-0d3e7b2a] :where(ul > li):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0.375em;\n}\n.article[data-v-0d3e7b2a] > :where(ul > li p):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0.75em;\n\n    margin-bottom: 0.75em;\n}\n.article[data-v-0d3e7b2a] > :where(ul > li > *:first-child):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 1.25em;\n}\n.article[data-v-0d3e7b2a] > :where(ul > li > *:last-child):not(:where([class~="not-prose"] *)) {\n\n    margin-bottom: 1.25em;\n}\n.article[data-v-0d3e7b2a] > :where(ol > li > *:first-child):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 1.25em;\n}\n.article[data-v-0d3e7b2a] > :where(ol > li > *:last-child):not(:where([class~="not-prose"] *)) {\n\n    margin-bottom: 1.25em;\n}\n.article[data-v-0d3e7b2a] :where(ul ul, ul ol, ol ul, ol ol):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0.75em;\n\n    margin-bottom: 0.75em;\n}\n.article[data-v-0d3e7b2a] :where(hr + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-0d3e7b2a] :where(h2 + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-0d3e7b2a] :where(h3 + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-0d3e7b2a] :where(h4 + *):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-0d3e7b2a] :where(thead th:first-child):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0;\n}\n.article[data-v-0d3e7b2a] :where(thead th:last-child):not(:where([class~="not-prose"] *)) {\n\n    padding-right: 0;\n}\n.article[data-v-0d3e7b2a] :where(tbody td:first-child):not(:where([class~="not-prose"] *)) {\n\n    padding-left: 0;\n}\n.article[data-v-0d3e7b2a] :where(tbody td:last-child):not(:where([class~="not-prose"] *)) {\n\n    padding-right: 0;\n}\n.article[data-v-0d3e7b2a] > :where(:first-child):not(:where([class~="not-prose"] *)) {\n\n    margin-top: 0;\n}\n.article[data-v-0d3e7b2a] > :where(:last-child):not(:where([class~="not-prose"] *)) {\n\n    margin-bottom: 0;\n}\n.article[data-v-0d3e7b2a] {\n\n    grid-column: 1 / -1;\n\n    margin: auto;\n\n    width: 100%;\n\n    max-width: 48rem;\n\n    padding: 1rem;\n}\n@media (min-width: 768px) {\n.article[data-v-0d3e7b2a] {\n\n        grid-column: span 6 / span 6;\n\n        grid-column-start: 1;\n\n        grid-row-start: 1;\n}\n}\n')();
const meta$8 = void 0;
...
const Header_vue_vue_type_style_index_0_lang = /* @__PURE__ */ (() => "\na {\n    text-decoration: none;\n}\n")();
const _sfc_main$P = {};
function _sfc_ssrRender$l(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/teams" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          createVNode("button", { class: "rounded-md shadow w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-500 hover:bg-blue-500" }, " Stats ")
        ];
      }
    }),
    _: 1
  ...
  _push(`</div></div></main></div><div class="container mx-auto flex flex-col items-center"><div class="w-full"><img${ssrRenderAttr("src", _imports_0$2)} alt=""></div></div></div>`);
}
...
function _sfc_ssrRender$k(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--]--></dl></div><div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8"><img${ssrRenderAttr("src", _imports_0$1)} alt="hockey" class="bg-gray-100 rounded-lg"><img${ssrRenderAttr("src", _imports_1)} alt="hockey" class="bg-gray-100 rounded-lg"><img${ssrRenderAttr("src", _imports_2)} alt="hockey" class="bg-gray-100 rounded-lg"><img${ssrRenderAttr("src", _imports_3)} alt="hockey" class="bg-gray-100 rounded-lg"></div></div></div>`);
}
...
const _sfc_main$N = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen" }, _attrs))}><div class="flex items-center justify-center px-4 sm:px-6 lg:px-8"><div class="max-w-md w-full space-y-8"><div><div class="h-25 w-25"></div><div class="flex"><img class="mx-auto h-24 w-auto"${ssrRenderAttr("src", _imports_0$2)} alt="rotorink logo"></div><h2 class="mt-6 py-9 text-center text-3xl font-extrabold text-gray-900"> Sign in </h2></div>`);
      if (hasError.value) {
...
const _sfc_main$M = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Features = __nuxt_component_0$2;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-screen" }, _attrs))}><div class="flex items-center justify-center px-4 sm:px-6 lg:px-8"><div class="max-w-md w-full"><div class="flex"><img class="mx-auto h-24 w-auto"${ssrRenderAttr("src", _imports_0$2)} alt="rotorink logo"></div><div><h2 class="text-center text-3xl font-extrabold mt-5 text-gray-900">Sign Up</h2></div>`);
...
const _sfc_main$K = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex relative flex-col bg-white border shadow-md rounded-xl dark:bg-gray-700 dark:border-gray-700 dark:shadow-slate-700/[.7]" }, _attrs))}>`);
      if (unref(isLiked)) {
      ...
      _push(`<img class="w-full h-auto rounded-t-xl"${ssrRenderAttr("src", unref(matchPlayerImage)(__props.player.person.fullName))} alt="Player Profile"><div class="p-4 md:p-5"><h3 class="text-lg font-bold text-gray-800 dark:text-white">${ssrInterpolate(__props.player.person.fullName)}</h3><p class="mt-1 text-white text-gray-400"></p><div class="flex inline-flex justify-center items-center gap-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
...
const _sfc_main$J = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`https://statsapi.web.nhl.com/api/v1/teams/${route.params.id}/roster`)), __temp = await __temp, __restore(), __temp);
    const playerIds = [...data.value.roster].map((player2) => {
      return player2.person.id;
    });
    playerLikes.value = ([__temp, __restore] = withAsyncContext(() => getUserLikes(playerIds.toString())), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_off_canvas, { player: player.value }, null, _parent));
      _push(`<div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3 px-4"><!--[-->`);
      ssrRenderList(unref(data).roster, (player2) => {
        _push(ssrRenderComponent(_component_player_card, {
          "user-id": unref(user) ? unref(user).id : void 0,
          player: player2,
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({
        ...
        role: "alert"
      }, _attrs))}><h3 class="ml-3 font-bold mb-3">Comments</h3><form class="w-full d-flex flex-col"><input${ssrRenderAttr("value", comment.value)} required type="text" placeholder="Enter Comment" class="py-3 px-4 block w-full border focus:outline-none border-gray-200 rounded-md text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"><button class="ml-auto block w-20 mt-2 py-2 px-2 rounded-md border-2 border-gray-900 font-semibold text-gray-800 hover:bg-gray-200 hover:border-gray-800 focus:outline-none transition-all text-sm dark:hover:bg-gray-900 dark:border-gray-900 dark:hover:border-gray-900 dark:text-white dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800">`);
      if (commenting.value) {
      ...
      ssrRenderList(playerComments.value, (comment2, i) => {
...
const _sfc_main$H = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_NuxtLink = __nuxt_component_2$1;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]" }, _attrs))}><img class="mx-auto rounded-t-xl w-32"${ssrRenderAttr("src", unref(matchPlayerImage)((_a = __props.team) == null ? void 0 : _a.locationName))} alt="Player Profile"><div class="p-4 md:p-5"><h3 class="text-lg font-bold text-gray-800 dark:text-white">${ssrInterpolate(__props.team.name)}</h3><p class="mt-1 text-gray-800 dark:text-gray-400">${ssrInterpolate(__props.team.locationName)} <br></p>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        class: "mt-3 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800",
...
const _sfc_main$G = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("https://statsapi.web.nhl.com/api/v1/teams")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Head = resolveComponent("Head");
      const _component_Script = resolveComponent("Script");
      ...
      ssrRenderList(unref(data).teams, (team) => {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderSuspense(_push, {
        default: () => {
          if (unref(error)) {
            _push(ssrRenderComponent(unref(_sfc_main$C), { error: unref(error) }, null, _parent));
          } else {
...
const SiteHeader_vue_vue_type_style_index_0_scoped_true_lang = /* @__PURE__ */ (() => "\n.site-header[data-v-95d2422a] {\n\n    position: -webkit-sticky;\n\n    position: sticky;\n\n    top: 0px;\n\n    z-index: 20;\n\n    width: 100%;\n\n    border-bottom-width: 2px;\n\n    border-color: rgb(255 255 255 / var(--tw-border-opacity));\n\n    --tw-border-opacity: 0.3;\n\n    background-color: rgb(241 245 249 / var(--tw-bg-opacity));\n\n    --tw-bg-opacity: 0.4;\n\n    padding: 1rem;\n\n    --tw-backdrop-blur: blur(16px);\n\n    -webkit-backdrop-filter: var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia);\n\n            backdrop-filter: var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)\n}\n.site-header > .wrapper[data-v-95d2422a] {\n\n    margin: auto;\n\n    display: flex;\n\n    max-width: 72rem;\n\n    align-items: center;\n\n    justify-content: space-between\n}\n.site-logo[data-v-95d2422a] {\n\n    font-size: 1.125rem;\n\n    line-height: 1.75rem;\n\n    font-weight: 900\n}\n")();
const _sfc_main$z = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<header${ssrRenderAttrs(mergeProps({ class: "site-header" }, _attrs))} data-v-95d2422a><div class="wrapper" data-v-95d2422a>`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "no-underline"
      }, {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(data).article) {
        _push(`<header class="article-header" data-v-0d3e7b2a><div class="img-cont h-72 mb-12" data-v-0d3e7b2a><img${ssrRenderAttr("src", `/${unref(data).article.img}`)}${ssrRenderAttr("alt", unref(data).article.title)} class="rounded-2xl" data-v-0d3e7b2a></div><h1 class="heading" data-v-0d3e7b2a>${ssrInterpolate(unref(data).article.title)}</h1><p class="supporting" data-v-0d3e7b2a>${ssrInterpolate(unref(data).article.description)}</p><ul class="article-tags" data-v-0d3e7b2a><!--[-->`);
        ssrRenderList(unref(data).article.tags, (tag, n) => {
          _push(`<li class="tag" data-v-0d3e7b2a>${ssrInterpolate(tag)}</li>`);
        });
        _push(`<!--]--></ul></header>`);
      } else {
        _push(`<!---->`);
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section>`);
      if (player.value) {
        _push(`<div class="md:w-1/2 md:mx-auto mt-4 mx-4 flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]"><div class="p-4 md:p-5"><h2 class="text-2xl font-bold text-gray-800 dark:text-white text-center">${ssrInterpolate((_a = player.value) == null ? void 0 : _a.fullName)}</h2><img class="mx-auto rounded-t-xl w-32"${ssrRenderAttr("src", unref(matchPlayerImage)((_b = player.value) == null ? void 0 : _b.fullName))} alt="Player Profile"><h5 class="text-md font-bold text-gray-800 dark:text-white text-center">${ssrInterpolate((_d = (_c = player.value) == null ? void 0 : _c.currentTeam) == null ? void 0 : _d.name)}</h5><div class="mt-4 flex justify-center space-between"><div class="mr-2"><p class="mb-4 text-gray-800 dark:text-gray-400"> Height: ${ssrInterpolate((_e = player.value) == null ? void 0 : _e.height)}</p>`);
        if (((_g = (_f = player.value) == null ? void 0 : _f.stats) == null ? void 0 : _g.stat.shots) && ((_i = (_h = player.value) == null ? void 0 : _h.stats) == null ? void 0 : _i.stat.games)) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> SPG: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${ssrInterpolate((((_k = (_j = player.value) == null ? void 0 : _j.stats) == null ? void 0 : _k.stat.shots) / ((_m = (_l = player.value) == null ? void 0 : _l.stats) == null ? void 0 : _m.stat.games)).toFixed(2))}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_o = (_n = player.value) == null ? void 0 : _n.stats) == null ? void 0 : _o.stat.goalsAgainst) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> Goals Against: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${ssrInterpolate((_q = (_p = player.value) == null ? void 0 : _p.stats) == null ? void 0 : _q.stat.goalsAgainst)}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_s = (_r = player.value) == null ? void 0 : _r.stats) == null ? void 0 : _s.stat.saves) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> Saves: ${ssrInterpolate((_u = (_t = player.value) == null ? void 0 : _t.stats) == null ? void 0 : _u.stat.saves)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_w = (_v = player.value) == null ? void 0 : _v.stats) == null ? void 0 : _w.stat.games) {
          _push(`<p class="mt-4 mb-4 text-white font-bold"> Games: ${ssrInterpolate((_y = (_x = player.value) == null ? void 0 : _x.stats) == null ? void 0 : _y.stat.games)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (((_A = (_z = player.value) == null ? void 0 : _z.stats) == null ? void 0 : _A.stat.goals) && ((_C = (_B = player.value) == null ? void 0 : _B.stats) == null ? void 0 : _C.stat.games)) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> GPG: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${ssrInterpolate((((_E = (_D = player.value) == null ? void 0 : _D.stats) == null ? void 0 : _E.stat.goals) / ((_G = (_F = player.value) == null ? void 0 : _F.stats) == null ? void 0 : _G.stat.games)).toFixed(2))}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_I = (_H = player.value) == null ? void 0 : _H.stats) == null ? void 0 : _I.stat.assists) {
          _push(`<p class="font-bold text-white"> Assists: ${ssrInterpolate((_K = (_J = player.value) == null ? void 0 : _J.stats) == null ? void 0 : _K.stat.assists)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="ml-2"><p class="mb-4 text-gray-800 dark:text-gray-400"> Season: ${ssrInterpolate((_M = (_L = player.value) == null ? void 0 : _L.stats) == null ? void 0 : _M.season)}</p>`);
        if ((_O = (_N = player.value) == null ? void 0 : _N.stats) == null ? void 0 : _O.stat.shots) {
          _push(`<p class="font-bold mt-4 mb-4 text-white"><span> Shots: ${ssrInterpolate((_Q = (_P = player.value) == null ? void 0 : _P.stats) == null ? void 0 : _Q.stat.shots)}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_S = (_R = player.value) == null ? void 0 : _R.stats) == null ? void 0 : _S.stat.gamesStarted) {
          _push(`<p class="font-bold mt-4 mb-4 text-white"> Games Started: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${ssrInterpolate((_U = (_T = player.value) == null ? void 0 : _T.stats) == null ? void 0 : _U.stat.gamesStarted)}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_W = (_V = player.value) == null ? void 0 : _V.stats) == null ? void 0 : _W.stat.shotsAgainst) {
          _push(`<p class="font-bold mt-4 mb-4 text-white"> Shots Against: ${ssrInterpolate((_Y = (_X = player.value) == null ? void 0 : _X.stats) == null ? void 0 : _Y.stat.shotsAgainst)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if ((__ = (_Z = player.value) == null ? void 0 : _Z.stats) == null ? void 0 : __.stat.hits) {
          _push(`<p class="mt-4 mb-4 text-white font-bold"> Hits: ${ssrInterpolate((_aa = (_$ = player.value) == null ? void 0 : _$.stats) == null ? void 0 : _aa.stat.hits)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_ca = (_ba = player.value) == null ? void 0 : _ba.stats) == null ? void 0 : _ca.stat.goals) {
          _push(`<p class="text-white font-bold">Goals: ${ssrInterpolate((_ea = (_da = player.value) == null ? void 0 : _da.stats) == null ? void 0 : _ea.stat.goals)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
        if (unref(isLiked)) {
          _push(`<button class="mt-3 py-2 px-2 inline-flex justify-center items-center gap-2 rounded-md border-2 border-blue-500 font-semibold text-blue-500 focus:outline-none transition-all text-sm"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21C8.38661 17.7733 2 13.7597 2 8.3951C2 5.37384 4.42 3 7.5 3C9.24 3 10.91 3.74441 12 5C13.09 3.74441 14.76 3 16.5 3C19.58 3 22 5.37384 22 8.3951C22 13.751 15.6214 17.7907 12 21Z" fill="#2F80ED"></path></svg><span>${ssrInterpolate(playerLikes.value.length)} Likes</span></button>`);
        } else {
          _push(`<button type="button" class="mt-3 py-2 px-2 inline-flex justify-center items-center gap-2 rounded-md border-2 border-gray-900 font-semibold text-gray-800 hover:bg-gray-200 hover:border-gray-800 focus:outline-none transition-all text-sm dark:hover:bg-gray-900 dark:border-gray-900 dark:hover:border-gray-900 dark:text-white dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800"><svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10 2C9.66042 1.60884 9.26455 1.26729 8.82781 0.982401C7.86267 0.352837 6.69792 0 5.5 0C2.42 0 0 2.37384 0 5.3951C0 6.46861 0.255742 7.48801 0.693829 8.45784C2.0526 11.4686 5.16576 14.0093 7.8455 16.1963C8.61699 16.8259 9.35256 17.4262 10 18C10.6474 17.4262 11.383 16.8259 12.1545 16.1963C14.8342 14.0093 17.9473 11.4687 19.3061 8.458C19.7442 7.48813 20 6.46866 20 5.3951C20 2.37384 17.58 0 14.5 0C13.3021 0 12.1373 0.352837 11.1722 0.982401C10.7354 1.26729 10.3396 1.60884 10 2ZM10 15.3699C10.3228 15.1024 10.6527 14.8326 10.9822 14.5633C11.2612 14.3351 11.5399 14.1073 11.8136 13.8813C12.9091 12.9769 13.9814 12.058 14.9309 11.095C16.106 9.90333 16.9793 8.75632 17.4879 7.62419C17.8233 6.8767 18 6.13633 18 5.3951C18 3.51455 16.5119 2 14.5 2C13.3116 2 12.2025 2.51373 11.5103 3.31111L10 5.05084L8.48971 3.31111C7.79748 2.51373 6.68843 2 5.5 2C3.48808 2 2 3.51455 2 5.3951C2 6.13633 2.17674 6.8767 2.51214 7.62419C3.02069 8.75633 3.89402 9.90333 5.06909 11.095C6.01864 12.058 7.09095 12.9769 8.18643 13.8813C8.46009 14.1073 8.73877 14.3351 9.01783 14.5633C9.34727 14.8326 9.67722 15.1024 10 15.3699Z" fill="#222B45"></path></svg><span>${ssrInterpolate(playerLikes.value.length)} Likes</span></button>`);
        }
        _push(`</div>`);
