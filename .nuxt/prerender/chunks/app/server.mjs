import { g as getDefaultExportFromNamespaceIfNotNamed, v as vue_cjs_prod, r as reactivity, s as serverRenderer, a as require$$0$1 } from '../renderer.mjs';
...
import * as chart from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/chart.js/dist/chart.js';
...
const require$$0 = /*@__PURE__*/getDefaultExportFromNamespaceIfNotNamed(chart);

Object.defineProperty(dist, '__esModule', { value: true });

var chart_js = require$$0;
...
dist.Line = Line;
dist.Pie = Pie;
var PolarArea_1 = dist.PolarArea = PolarArea;
dist.Radar = Radar;
dist.Scatter = Scatter;
dist.generateChart = generateChart;
...
(function(exports) {
  ...
  function createMemoryHistory(base = "") {
    ...
    function triggerListeners(to2, from2, { direction, delta }) {
      const info = {
        direction,
        delta,
        type: NavigationType.pop
    ...
    const routerHistory = {
      ...
      go(delta, shouldTrigger = true) {
        const from2 = this.location;
        const direction = delta < 0 ? NavigationDirection.back : NavigationDirection.forward;
        position = Math.max(0, Math.min(position + delta, queue.length - 1));
        if (shouldTrigger) {
          triggerListeners(this.location, from2, {
            direction,
            delta
          });
        }
 ...
 ${JSON.stringify(location2)}${currentLocation ? "\nwhile being at\n" + JSON.stringify(currentLocation) : ""}`;
  ...
  const RouterViewImpl = /* @__PURE__ */ vue.defineComponent({
    ...
    setup(props, { attrs, slots }) {
      ...
      vue.watch(() => [viewRef.value, matchedRouteRef.value, props.name], ([instance, to2, name], [oldInstance, from2, oldName]) => {
        if (to2) {
...
const toDisplayString = (val) => {
  return isString(val) ? val : val == null ? "" : isArray$1(val) || isObject$2(val) && (val.toString === objectToString || !isFunction$1(val.toString)) ? JSON.stringify(val, replacer, 2) : String(val);
};
...
const metaConfig = { "globalMeta": { "charset": "utf-8", "viewport": "width=device-width, initial-scale=1", "meta": [], "link": [{ "rel": "icon", "type": "image/x-icon", "href": "/favicon.ico?v2" }], "style": [], "script": [], "title": "rotorink" } };
const metaMixin = {
  created() {
    const instance = vue_cjs_prod.getCurrentInstance();
    if (!instance) {
...
const __nuxt_component_0$5 = /* @__PURE__ */ _export_sfc(_sfc_main$T, [["__scopeId", "data-v-6f21b509"]]);
...
merge$1([xml, xlink, xmlns, aria, svg], "svg");
...
function renderNode(node, h22, documentMeta) {
  var _a;
  const originalTag = node.tag;
  const renderTag = typeof ((_a = node.props) == null ? void 0 : _a.__ignoreMap) === "undefined" && documentMeta.tags[node.tag] || node.tag;
  if (node.type === "text") {
    return h22(vue_cjs_prod.Text, node.value);
  }
  const component = resolveVueComponent(renderTag);
  if (typeof component === "object") {
    component.tag = originalTag;
  }
  return h22(component, propsToData(node, documentMeta), renderSlots(node, h22, documentMeta));
}
function renderSlots(node, h22, documentMeta) {
  const children = node.children || [];
  const slots = children.reduce((data, node2) => {
    if (!isTemplate(node2)) {
      data[DEFAULT_SLOT].push(renderNode(node2, h22, documentMeta));
      return data;
    }
    if (isDefaultTemplate(node2)) {
      data[DEFAULT_SLOT].push(...node2.children.map((child) => renderNode(child, h22, documentMeta)));
      return data;
    }
    const slotName = getSlotName(node2);
    data[slotName] = node2.children.map((child) => renderNode(child, h22, documentMeta));
    return data;
  }, {
    [DEFAULT_SLOT]: []
  });
...
const _sfc_main$R = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<ul${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "prev-next-cont" }, _attrs))} data-v-4d02dcb6><li class="link-item prev" data-v-4d02dcb6>`);
      if (__props.prev) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span data-v-4d02dcb6${_scopeId}>${serverRenderer.exports.ssrInterpolate(__props.prev.title)}</span>`);
            } else {
              return [
      ...
      if (__props.next) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
          ...
          default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-4d02dcb6${_scopeId}>${serverRenderer.exports.ssrInterpolate(__props.next.title)}</span>`);
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$R, [["__scopeId", "data-v-4d02dcb6"]]);
...
const ContentQuery = vue_cjs_prod.defineComponent({
  ...
  async setup(props) {
    ...
    const { data, refresh } = await useAsyncData(`content-query-${hash(props)}`, () => {
      ...
      if (skip2.value) {
        queryBuilder = queryBuilder.skip(skip2.value);
      }
      if (locale.value) {
...
const meta$6 = void 0;
const _imports_0$2 = publicAssetsURL(`img/hockeyphone.png`);
const _sfc_main$P = {};
function _sfc_ssrRender$l(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_2$1;
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "p-20 h-screen w-screen flex flex-col-reverse md:flex-row items-center justify-center" }, _attrs))}><div class="content text-3xl text-center md:text-left"><main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-4 sm:px-6 md:mt-16 lg:mt-10 lg:px-4 xl:mt-8"><div class="sm:text-center lg:text-left"><h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl"><span class="block xl:inline">rotorink</span><span class="block text-red-600 xl:inline"> stats and stories</span></h1><p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0"> Welcome to the home of hockey dfs news, lineup and props content. </p><div class="mt-5 flex">`);
  ...
  _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, { to: "/blog" }, {
    default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        return [
          vue_cjs_prod.createVNode("button", { class: "ml-2 rounded-md shadow w-full flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gray-900 hover:bg-gray-400" }, " Blog ")
        ];
      }
    }),
    _: 1
  }, _parent));
  _push(`</div></div></main></div><div class="container mx-auto flex flex-col items-center"><div class="w-full"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0$2)} alt=""></div></div></div>`);
}
...
const __nuxt_component_0$3 = /* @__PURE__ */ _export_sfc(_sfc_main$P, [["ssrRender", _sfc_ssrRender$l]]);
const meta$5 = void 0;
const _imports_0$1 = publicAssetsURL(`img//UFOBag.svg`);
...
function _sfc_ssrRender$k(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "bg-white" }, _attrs))}><div class="max-w-2xl mx-auto py-24 px-4 grid items-center grid-cols-1 gap-y-16 gap-x-8 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8 lg:grid-cols-2"><div><h2 class="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Features</h2><p class="mt-4 text-gray-500">Prosper in your fantasy leagues and apps with articles on betting, lineup and season-long fantasy advice.</p><dl class="mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8"><!--[-->`);
  serverRenderer.exports.ssrRenderList($data.features, (feature) => {
    _push(`<div class="border-t border-gray-200 pt-4"><dt class="font-medium text-gray-900">${serverRenderer.exports.ssrInterpolate(feature.name)}</dt><dd class="mt-2 text-sm text-gray-500">${serverRenderer.exports.ssrInterpolate(feature.description)}</dd></div>`);
  });
  _push(`<!--]--></dl></div><div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0$1)} alt="hockey" class="bg-gray-100 rounded-lg"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_1)} alt="hockey" class="bg-gray-100 rounded-lg"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_2)} alt="hockey" class="bg-gray-100 rounded-lg"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_3)} alt="hockey" class="bg-gray-100 rounded-lg"></div></div></div>`);
}
...
const __nuxt_component_0$2 = /* @__PURE__ */ _export_sfc(_sfc_main$O, [["ssrRender", _sfc_ssrRender$k]]);
const _sfc_main$N = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Features = __nuxt_component_0$2;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "h-screen" }, _attrs))}><div class="flex items-center justify-center px-4 sm:px-6 lg:px-8"><div class="max-w-md w-full space-y-8"><div><div class="h-25 w-25"></div><div class="flex"><img class="mx-auto h-24 w-auto"${serverRenderer.exports.ssrRenderAttr("src", _imports_0$2)} alt="rotorink logo"></div><h2 class="mt-6 py-9 text-center text-3xl font-extrabold text-gray-900"> Sign in </h2></div>`);
      if (hasError.value) {
      ...
      _push(`</div></div>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Features, null, null, _parent));
      _push(`</div>`);
    };
  }
});
...
const _sfc_main$M = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Features = __nuxt_component_0$2;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "h-screen" }, _attrs))}><div class="flex items-center justify-center px-4 sm:px-6 lg:px-8"><div class="max-w-md w-full"><div class="flex"><img class="mx-auto h-24 w-auto"${serverRenderer.exports.ssrRenderAttr("src", _imports_0$2)} alt="rotorink logo"></div><div><h2 class="text-center text-3xl font-extrabold mt-5 text-gray-900">Sign Up</h2></div>`);
    ...
    index(chart, e, options, useFinalPosition) {
      ...
      chart.getSortedVisibleDatasetMetas().forEach((meta2) => {
        ...
        if (element && !element.skip) {
          elements.push({ element, datasetIndex: meta2.index, index: index2 });
        }
      });
      return elements;
    },
...
Chart.register(plugin_title, plugin_tooltip, plugin_legend, ArcElement, RadialLinearScale);
const PolarAreaChart = vue_cjs_prod.defineComponent({
  name: "PolarAreaChart",
  components: {
    PolarArea: PolarArea_1
  },
  props: {
    chartId: {
      type: String,
  ...
  setup(props) {
      ...
      datasets: [
        {
          ...
          data: [
            (_a = props.stats) == null ? void 0 : _a.assists,
            (_b = props.stats) == null ? void 0 : _b.goals,
            (_c = props.stats) == null ? void 0 : _c.pim,
            (_d = props.stats) == null ? void 0 : _d.games,
            (_e = props.stats) == null ? void 0 : _e.hits,
            (_f = props.stats) == null ? void 0 : _f.powerPlayGoals,
            (_g = props.stats) == null ? void 0 : _g.powerPlayPoints,
            (_h = props.stats) == null ? void 0 : _h.points,
            props.stats
          ]
        }
      ]
    ...
    return () => vue_cjs_prod.h(PolarArea_1, {
      chartData,
      chartOptions,
...
_sfc_main$L.setup = (props, ctx) => {
  const ssrContext = vue_cjs_prod.useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/OffCanvas.vue");
...
const _sfc_main$K = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props, { emit }) {
    const props = __props;
    const likesCount = vue_cjs_prod.computed(() => {
      return props.likes.length;
    });
    vue_cjs_prod.computed(() => {
      return props.likes.find((like) => like.userId === props.userId);
    });
    const isLiked = vue_cjs_prod.computed(() => {
      if (!props.userId)
        return false;
      const index2 = props.likes.findIndex((like) => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        ...
        to: `/teams/${useRoute().params.id}/player/` + __props.player.person.id
      }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` View Player `);
            ...
            return [
              vue_cjs_prod.createTextVNode(" View Player ")
            ];
          }
        }),
        _: 1
...
const _sfc_main$J = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    const user = useState("user");
    const player = vue_cjs_prod.ref(null);
    const config = useRuntimeConfig();
    const playerLikes = vue_cjs_prod.ref(null);
    const { data } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch(`https://statsapi.web.nhl.com/api/v1/teams/${route.params.id}/roster`)), __temp = await __temp, __restore(), __temp);
    const playerIds = [...data.value.roster].map((player2) => {
      return player2.person.id;
    });
    playerLikes.value = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getUserLikes(playerIds.toString())), __temp = await __temp, __restore(), __temp);
    async function likePlayer(id) {
      ...
      try {
        ...
        if (playerLikes.value[id]) {
          playerLikes.value[id].push(__spreadValues({}, like));
        } else {
          playerLikes.value[id] = [__spreadValues({}, like)];
        }
      } catch (error) {
        console.log(error);
      }
    ...
    async function unlikePlayer({ id, playerId }) {
      try {
        ...
        const index2 = playerLikes.value[playerId].findIndex((like) => like.id === id);
        playerLikes.value[playerId].splice(index2, 1);
      } catch (error) {
        console.log(error);
      }
    }
    async function showPlayer(id) {
      ...
      const res = await Promise.all([
        ...
        useFetch(`https://statsapi.web.nhl.com/api/v1/people/${id}/stats/?stats=statsSingleSeason&season=${config.public.SEASON}`)
      ]);
      player.value = __spreadProps(__spreadValues({}, res[0].data.value.people[0]), {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_off_canvas = _sfc_main$L;
      const _component_player_card = _sfc_main$K;
      ...
      _push(`<section><h2 class="text-2xl mt-3 mb-4 text-center">Team Page</h2><p class="text-md mb-4 text-center">Select Player to View Stats</p><p class="text-md mb-4 text-center">Sign in or register to like and comment on your favorite plays</p>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_off_canvas, { player: player.value }, null, _parent));
      _push(`<div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-3 px-4"><!--[-->`);
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(data).roster, (player2) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_player_card, {
          "user-id": vue_cjs_prod.unref(user) ? vue_cjs_prod.unref(user).id : void 0,
          player: player2,
          likes: playerLikes.value[player2.person.id],
          key: player2.person.id,
          onShowPlayer: showPlayer,
          onLikePlayer: likePlayer,
          onUnlikePlayer: unlikePlayer
        }, null, _parent));
      });
...
const _sfc_main$I = {
  ...
  async setup(__props) {
    let __temp, __restore;
    const route = useRoute();
    const playerComments = vue_cjs_prod.ref([]);
    const comment = vue_cjs_prod.ref("");
    const commenting = vue_cjs_prod.ref(false);
    const user = useState("user");
    playerComments.value = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getPlayerComments(route.params.player)), __temp = await __temp, __restore(), __temp);
    const userComment = vue_cjs_prod.computed(() => {
      if (!user.value)
        return false;
      const index2 = playerComments.value.findIndex((comment2) => comment2.userId === user.value.id);
      return index2 > -1;
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({
        ...
        role: "alert"
      }, _attrs))}><h3 class="ml-3 font-bold mb-3">Comments</h3><form class="w-full d-flex flex-col"><input${serverRenderer.exports.ssrRenderAttr("value", comment.value)} required type="text" placeholder="Enter Comment" class="py-3 px-4 block w-full border focus:outline-none border-gray-200 rounded-md text-sm dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400"><button class="ml-auto block w-20 mt-2 py-2 px-2 rounded-md border-2 border-gray-900 font-semibold text-gray-800 hover:bg-gray-200 hover:border-gray-800 focus:outline-none transition-all text-sm dark:hover:bg-gray-900 dark:border-gray-900 dark:hover:border-gray-900 dark:text-white dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800">`);
      if (commenting.value) {
      ...
      serverRenderer.exports.ssrRenderList(playerComments.value, (comment2, i) => {
        _push(`<div class="ml-3 mb-2 py-2 border-t border-gray-200"><div class="flex gap-3 items-center"><img${serverRenderer.exports.ssrRenderAttr("src", _imports_0)} class="rounded-full w-10 h-10" alt="avatar"><div><h4 class="text-base m-0 leading-3">${serverRenderer.exports.ssrInterpolate(comment2.user.name)}</h4><span class="text-xs leading-3">@${serverRenderer.exports.ssrInterpolate(comment2.user.username)}</span></div>`);
        if (vue_cjs_prod.unref(userComment)) {
        ...
        _push(`</div><p class="text-base mt-2 text-gray-700 dark:text-gray-400 ml-12">${serverRenderer.exports.ssrInterpolate(comment2.comment)}</p></div>`);
      });
      _push(`<!--]--></div></div>`);
    };
  }
...
const _sfc_main$H = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      const _component_NuxtLink = __nuxt_component_2$1;
      _push(`<div${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]" }, _attrs))}><img class="mx-auto rounded-t-xl w-32"${serverRenderer.exports.ssrRenderAttr("src", vue_cjs_prod.unref(matchPlayerImage)((_a = __props.team) == null ? void 0 : _a.locationName))} alt="Player Profile"><div class="p-4 md:p-5"><h3 class="text-lg font-bold text-gray-800 dark:text-white">${serverRenderer.exports.ssrInterpolate(__props.team.name)}</h3><p class="mt-1 text-gray-800 dark:text-gray-400">${serverRenderer.exports.ssrInterpolate(__props.team.locationName)} <br></p>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        class: "mt-3 py-3 px-4 inline-flex justify-center items-center gap-2 rounded-md border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm dark:focus:ring-offset-gray-800",
        ...
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              vue_cjs_prod.createTextVNode(" View Players ")
            ];
          }
        }),
        _: 1
...
const _sfc_main$G = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    let __temp, __restore;
    const { data } = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useFetch("https://statsapi.web.nhl.com/api/v1/teams")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Head = vue_cjs_prod.resolveComponent("Head");
      const _component_Script = vue_cjs_prod.resolveComponent("Script");
      const _component_TeamCard = _sfc_main$H;
      _push(`<main${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Head, null, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(data).teams, (team) => {
        _push(serverRenderer.exports.ssrRenderComponent(_component_TeamCard, {
          team,
          key: team.id
        }, null, _parent));
      });
...
const _sfc_main$A = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    const user = useState("user");
    const hideActions = reactivity.exports.ref(true);
    const userActions = reactivity.exports.ref(null);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><span class="mr-2"><strong>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(user).username)}</strong></span><img${serverRenderer.exports.ssrRenderAttr("src", avatar(vue_cjs_prod.unref(user).avatarUrl))} class="rounded-full w-10 h-10 mr-2" alt="avatar"><ul class="${serverRenderer.exports.ssrRenderClass([[{ hidden: hideActions.value }], "dropdown-menu min-w-max absolute bottom bg-white text-base z-100 float-left py-2 list-none text-left rounded-lg shadow-lg mt-1 top- m-0 bg-clip-padding border-none"])}" aria-labelledby="dropdownMenuButton1"><li><a class="dropdown-item text-sm py-2 px-4 font-normal block w-full whitespace-nowrap bg-transparent text-gray-800 hover:bg-gray-400" href="#">logout</a></li></ul></div>`);
    };
  }
});
...
const _sfc_main$z = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtLink = __nuxt_component_2$1;
      const _component_User = _sfc_main$A;
      const _component_nuxt_link = __nuxt_component_2$1;
      _push(`<header${serverRenderer.exports.ssrRenderAttrs(vue_cjs_prod.mergeProps({ class: "site-header" }, _attrs))} data-v-95d2422a><div class="wrapper" data-v-95d2422a>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_NuxtLink, {
        to: "/",
        class: "no-underline"
      }, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<figure class="site-logo" data-v-95d2422a${_scopeId}><h1 data-v-95d2422a${_scopeId}>rotorink</h1></figure>`);
          } else {
            return [
              vue_cjs_prod.createVNode("figure", { class: "site-logo" }, [
                vue_cjs_prod.createVNode("h1", null, "rotorink")
              ])
            ];
          }
        }),
      ...
      _push(`<nav class="site-nav" data-v-95d2422a><ul class="links" data-v-95d2422a><div class="flex items-center justify-end md:flex-1 lg:w-0" data-v-95d2422a>`);
      if (vue_cjs_prod.unref(user)) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_User, { user: vue_cjs_prod.unref(user) }, null, _parent));
      } else {
        _push(`<!---->`);
      }
      _push(`<li class="link" data-v-95d2422a>`);
      if (!vue_cjs_prod.unref(user)) {
      ...
      _push(`</li><li class="link" data-v-95d2422a>`);
      if (!vue_cjs_prod.unref(user)) {
        _push(serverRenderer.exports.ssrRenderComponent(_component_nuxt_link, {
          to: "/login",
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["__scopeId", "data-v-95d2422a"]]);
const _sfc_main$y = /* @__PURE__ */ vue_cjs_prod.defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = vue_cjs_prod.withAsyncContext(() => useUser()), await __temp, __restore();
    return (_ctx, _push, _parent, _attrs) => {
...
const plugins = normalizePlugins(_plugins);
{
  entry = async function createNuxtAppServer(ssrContext) {
    ...
    vueApp.component("App", _sfc_main$y);
...
const InfoBox = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["__scopeId", "data-v-ad57dd5c"]]);
...
const ProseBlockquote = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["ssrRender", _sfc_ssrRender$j]]);
...
const ProseCode = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["ssrRender", _sfc_ssrRender$i]]);
...
const ProseCodeInline = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["ssrRender", _sfc_ssrRender$h]]);
...
const ProseEm = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["ssrRender", _sfc_ssrRender$g]]);
...
const ProseH1 = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["ssrRender", _sfc_ssrRender$f]]);
...
const ProseH5 = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["ssrRender", _sfc_ssrRender$e]]);
...
const ProseH6 = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["ssrRender", _sfc_ssrRender$d]]);
...
const ProseHr = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["ssrRender", _sfc_ssrRender$c]]);
...
const ProseLi = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["ssrRender", _sfc_ssrRender$b]]);
...
const ProseOl = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["ssrRender", _sfc_ssrRender$a]]);
...
const ProseP = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["ssrRender", _sfc_ssrRender$9]]);
...
const ProseStrong = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["ssrRender", _sfc_ssrRender$8]]);
...
const ProseTable = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["ssrRender", _sfc_ssrRender$7]]);
...
const ProseTbody = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["ssrRender", _sfc_ssrRender$6]]);
...
const ProseTd = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["ssrRender", _sfc_ssrRender$5]]);
...
const ProseTh = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["ssrRender", _sfc_ssrRender$4]]);
...
const ProseThead = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["ssrRender", _sfc_ssrRender$3]]);
...
const ProseTr = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["ssrRender", _sfc_ssrRender$2]]);
...
const ProseUl = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["ssrRender", _sfc_ssrRender$1]]);
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (vue_cjs_prod.unref(data).article) {
        _push(`<header class="article-header" data-v-0d3e7b2a><div class="img-cont h-72 mb-12" data-v-0d3e7b2a><img${serverRenderer.exports.ssrRenderAttr("src", `/${vue_cjs_prod.unref(data).article.img}`)}${serverRenderer.exports.ssrRenderAttr("alt", vue_cjs_prod.unref(data).article.title)} class="rounded-2xl" data-v-0d3e7b2a></div><h1 class="heading" data-v-0d3e7b2a>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(data).article.title)}</h1><p class="supporting" data-v-0d3e7b2a>${serverRenderer.exports.ssrInterpolate(vue_cjs_prod.unref(data).article.description)}</p><ul class="article-tags" data-v-0d3e7b2a><!--[-->`);
        serverRenderer.exports.ssrRenderList(vue_cjs_prod.unref(data).article.tags, (tag, n) => {
          _push(`<li class="tag" data-v-0d3e7b2a>${serverRenderer.exports.ssrInterpolate(tag)}</li>`);
        });
        _push(`<!--]--></ul></header>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<hr data-v-0d3e7b2a><section class="article-section" data-v-0d3e7b2a><aside class="aside" data-v-0d3e7b2a>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Toc, {
        links: vue_cjs_prod.unref(data).article.body.toc.links
      }, null, _parent));
      _push(`</aside><article class="article" data-v-0d3e7b2a>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_ContentRenderer, {
        ...
        empty: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<p data-v-0d3e7b2a${_scopeId}>No content found.</p>`);
          } else {
            return [
      ...
      _push(serverRenderer.exports.ssrRenderComponent(_component_Form, null, null, _parent));
...
const ____slug_ = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-0d3e7b2a"]]);
...
const _sfc_main$7 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_Head = vue_cjs_prod.resolveComponent("Head");
      const _component_Script = vue_cjs_prod.resolveComponent("Script");
      const _component_Tags = __nuxt_component_0$4;
...
const _sfc_main$1 = {
  ...
  async setup(__props) {
    ...
    const playerLikes = vue_cjs_prod.ref(null);
    const user = useState("user");
    const res = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => Promise.all([
      useFetch(`https://statsapi.web.nhl.com/api/v1/people/${route.params.player}`),
      useFetch(`https://statsapi.web.nhl.com/api/v1/people/${route.params.player}/stats/?stats=statsSingleSeason&season=${config.public.SEASON}`)
    ])), __temp = await __temp, __restore(), __temp);
    player.value = __spreadProps(__spreadValues({}, res[0].data.value.people[0]), {
      stats: res[1].data.value.stats[0].splits[0]
    });
    const likes = ([__temp, __restore] = vue_cjs_prod.withAsyncContext(() => getUserLikes(route.params.player)), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Head = vue_cjs_prod.resolveComponent("Head");
      const _component_Script = vue_cjs_prod.resolveComponent("Script");
      const _component_Comments = _sfc_main$I;
      _push(`<main${serverRenderer.exports.ssrRenderAttrs(_attrs)}>`);
      _push(serverRenderer.exports.ssrRenderComponent(_component_Head, null, {
        default: vue_cjs_prod.withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
      ...
      _push(`<section>`);
      if (player.value) {
        _push(`<div class="md:w-1/2 md:mx-auto mt-4 mx-4 flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]"><div class="p-4 md:p-5"><h2 class="text-2xl font-bold text-gray-800 dark:text-white text-center">${serverRenderer.exports.ssrInterpolate((_a = player.value) == null ? void 0 : _a.fullName)}</h2><img class="mx-auto rounded-t-xl w-32"${serverRenderer.exports.ssrRenderAttr("src", vue_cjs_prod.unref(matchPlayerImage)((_b = player.value) == null ? void 0 : _b.fullName))} alt="Player Profile"><h5 class="text-md font-bold text-gray-800 dark:text-white text-center">${serverRenderer.exports.ssrInterpolate((_d = (_c = player.value) == null ? void 0 : _c.currentTeam) == null ? void 0 : _d.name)}</h5><div class="mt-4 flex justify-center space-between"><div class="mr-2"><p class="mb-4 text-gray-800 dark:text-gray-400"> Height: ${serverRenderer.exports.ssrInterpolate((_e = player.value) == null ? void 0 : _e.height)}</p>`);
        if (((_g = (_f = player.value) == null ? void 0 : _f.stats) == null ? void 0 : _g.stat.shots) && ((_i = (_h = player.value) == null ? void 0 : _h.stats) == null ? void 0 : _i.stat.games)) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> SPG: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${serverRenderer.exports.ssrInterpolate((((_k = (_j = player.value) == null ? void 0 : _j.stats) == null ? void 0 : _k.stat.shots) / ((_m = (_l = player.value) == null ? void 0 : _l.stats) == null ? void 0 : _m.stat.games)).toFixed(2))}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_o = (_n = player.value) == null ? void 0 : _n.stats) == null ? void 0 : _o.stat.goalsAgainst) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> Goals Against: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${serverRenderer.exports.ssrInterpolate((_q = (_p = player.value) == null ? void 0 : _p.stats) == null ? void 0 : _q.stat.goalsAgainst)}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_s = (_r = player.value) == null ? void 0 : _r.stats) == null ? void 0 : _s.stat.saves) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> Saves: ${serverRenderer.exports.ssrInterpolate((_u = (_t = player.value) == null ? void 0 : _t.stats) == null ? void 0 : _u.stat.saves)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_w = (_v = player.value) == null ? void 0 : _v.stats) == null ? void 0 : _w.stat.games) {
          _push(`<p class="mt-4 mb-4 text-white font-bold"> Games: ${serverRenderer.exports.ssrInterpolate((_y = (_x = player.value) == null ? void 0 : _x.stats) == null ? void 0 : _y.stat.games)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if (((_A = (_z = player.value) == null ? void 0 : _z.stats) == null ? void 0 : _A.stat.goals) && ((_C = (_B = player.value) == null ? void 0 : _B.stats) == null ? void 0 : _C.stat.games)) {
          _push(`<p class="mt-4 mb-4 font-bold text-white"> GPG: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${serverRenderer.exports.ssrInterpolate((((_E = (_D = player.value) == null ? void 0 : _D.stats) == null ? void 0 : _E.stat.goals) / ((_G = (_F = player.value) == null ? void 0 : _F.stats) == null ? void 0 : _G.stat.games)).toFixed(2))}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_I = (_H = player.value) == null ? void 0 : _H.stats) == null ? void 0 : _I.stat.assists) {
          _push(`<p class="font-bold text-white"> Assists: ${serverRenderer.exports.ssrInterpolate((_K = (_J = player.value) == null ? void 0 : _J.stats) == null ? void 0 : _K.stat.assists)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="ml-2"><p class="mb-4 text-gray-800 dark:text-gray-400"> Season: ${serverRenderer.exports.ssrInterpolate((_M = (_L = player.value) == null ? void 0 : _L.stats) == null ? void 0 : _M.season)}</p>`);
        if ((_O = (_N = player.value) == null ? void 0 : _N.stats) == null ? void 0 : _O.stat.shots) {
          _push(`<p class="font-bold mt-4 mb-4 text-white"><span> Shots: ${serverRenderer.exports.ssrInterpolate((_Q = (_P = player.value) == null ? void 0 : _P.stats) == null ? void 0 : _Q.stat.shots)}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_S = (_R = player.value) == null ? void 0 : _R.stats) == null ? void 0 : _S.stat.gamesStarted) {
          _push(`<p class="font-bold mt-4 mb-4 text-white"> Games Started: <span class="text-gray-900 font-bold bg-cyan-400 py-1 px-2 rounded-md">${serverRenderer.exports.ssrInterpolate((_U = (_T = player.value) == null ? void 0 : _T.stats) == null ? void 0 : _U.stat.gamesStarted)}</span></p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_W = (_V = player.value) == null ? void 0 : _V.stats) == null ? void 0 : _W.stat.shotsAgainst) {
          _push(`<p class="font-bold mt-4 mb-4 text-white"> Shots Against: ${serverRenderer.exports.ssrInterpolate((_Y = (_X = player.value) == null ? void 0 : _X.stats) == null ? void 0 : _Y.stat.shotsAgainst)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if ((__ = (_Z = player.value) == null ? void 0 : _Z.stats) == null ? void 0 : __.stat.hits) {
          _push(`<p class="mt-4 mb-4 text-white font-bold"> Hits: ${serverRenderer.exports.ssrInterpolate((_aa = (_$ = player.value) == null ? void 0 : _$.stats) == null ? void 0 : _aa.stat.hits)}</p>`);
        } else {
          _push(`<!---->`);
        }
        if ((_ca = (_ba = player.value) == null ? void 0 : _ba.stats) == null ? void 0 : _ca.stat.goals) {
          _push(`<p class="text-white font-bold">Goals: ${serverRenderer.exports.ssrInterpolate((_ea = (_da = player.value) == null ? void 0 : _da.stats) == null ? void 0 : _ea.stat.goals)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
        if (vue_cjs_prod.unref(isLiked)) {
          _push(`<button class="mt-3 py-2 px-2 inline-flex justify-center items-center gap-2 rounded-md border-2 border-blue-500 font-semibold text-blue-500 focus:outline-none transition-all text-sm"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 21C8.38661 17.7733 2 13.7597 2 8.3951C2 5.37384 4.42 3 7.5 3C9.24 3 10.91 3.74441 12 5C13.09 3.74441 14.76 3 16.5 3C19.58 3 22 5.37384 22 8.3951C22 13.751 15.6214 17.7907 12 21Z" fill="#2F80ED"></path></svg><span>${serverRenderer.exports.ssrInterpolate(playerLikes.value.length)} Likes</span></button>`);
        } else {
          _push(`<button type="button" class="mt-3 py-2 px-2 inline-flex justify-center items-center gap-2 rounded-md border-2 border-gray-900 font-semibold text-gray-800 hover:bg-gray-200 hover:border-gray-800 focus:outline-none transition-all text-sm dark:hover:bg-gray-900 dark:border-gray-900 dark:hover:border-gray-900 dark:text-white dark:focus:ring-gray-900 dark:focus:ring-offset-gray-800"><svg width="20" height="18" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10 2C9.66042 1.60884 9.26455 1.26729 8.82781 0.982401C7.86267 0.352837 6.69792 0 5.5 0C2.42 0 0 2.37384 0 5.3951C0 6.46861 0.255742 7.48801 0.693829 8.45784C2.0526 11.4686 5.16576 14.0093 7.8455 16.1963C8.61699 16.8259 9.35256 17.4262 10 18C10.6474 17.4262 11.383 16.8259 12.1545 16.1963C14.8342 14.0093 17.9473 11.4687 19.3061 8.458C19.7442 7.48813 20 6.46866 20 5.3951C20 2.37384 17.58 0 14.5 0C13.3021 0 12.1373 0.352837 11.1722 0.982401C10.7354 1.26729 10.3396 1.60884 10 2ZM10 15.3699C10.3228 15.1024 10.6527 14.8326 10.9822 14.5633C11.2612 14.3351 11.5399 14.1073 11.8136 13.8813C12.9091 12.9769 13.9814 12.058 14.9309 11.095C16.106 9.90333 16.9793 8.75632 17.4879 7.62419C17.8233 6.8767 18 6.13633 18 5.3951C18 3.51455 16.5119 2 14.5 2C13.3116 2 12.2025 2.51373 11.5103 3.31111L10 5.05084L8.48971 3.31111C7.79748 2.51373 6.68843 2 5.5 2C3.48808 2 2 3.51455 2 5.3951C2 6.13633 2.17674 6.8767 2.51214 7.62419C3.02069 8.75633 3.89402 9.90333 5.06909 11.095C6.01864 12.058 7.09095 12.9769 8.18643 13.8813C8.46009 14.1073 8.73877 14.3351 9.01783 14.5633C9.34727 14.8326 9.67722 15.1024 10 15.3699Z" fill="#222B45"></path></svg><span>${serverRenderer.exports.ssrInterpolate(playerLikes.value.length)} Likes</span></button>`);
        }
        _push(`</div>`);
        _push(serverRenderer.exports.ssrRenderComponent(_component_Comments, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<!---->`);
      }
...
const _player_ = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  "default": _sfc_main$1
}, Symbol.toStringTag, { value: "Module" }));
...
const auth = defineNuxtRouteMiddleware(async (to2) => {
  let __temp, __restore;
...
const guest = defineNuxtRouteMiddleware(async (to2) => {
  let __temp, __restore;
  const user = ([__temp, __restore] = executeAsync(() => useUser()), __temp = await __temp, __restore(), __temp);
  if (user !== null && user !== void 0) {
    return "/";
