...
import { defineComponent, h, useSSRContext, ref, resolveComponent, withCtx, createVNode, unref, computed, mergeProps, createTextVNode } from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderList, ssrInterpolate, ssrRenderAttr } from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/vue/server-renderer/index.mjs';
import { PolarArea } from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/vue-chartjs/dist/index.cjs';
import { m as matchPlayerImage } from './methods-Dr2_CXld.mjs';
import { b as useRoute, e as useState, u as useRouter, d as useNuxtApp, a as __nuxt_component_0$1 } from './server.mjs';
import { a as addUserLike, r as removeUserLike } from './useLike-C3EBfnqv.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<img class="w-full h-auto rounded-t-xl"${ssrRenderAttr("src", __props.player.headshot || unref(matchPlayerImage)(__props.player.firstName.default + " " + __props.player.lastName.default))} alt="Player Profile"><div class="p-4 md:p-5"><h3 class="text-lg font-bold text-gray-800 dark:text-white">${ssrInterpolate(__props.player.firstName.default)} ${ssrInterpolate(__props.player.lastName.default)}</h3><p class="mt-1 text-white text-gray-400"></p><div class="flex inline-flex justify-center items-center gap-4">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        to: `/teams/${("useRoute" in _ctx ? _ctx.useRoute : unref(useRoute))().params.id}/player/` + __props.player.id
      }, {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_off_canvas = _sfc_main$2;
      const _component_player_card = _sfc_main$1;
...
//# sourceMappingURL=index-Cbs4etpd.mjs.map
