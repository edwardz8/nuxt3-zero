...
import { defineComponent, h, useSSRContext, ref, withAsyncContext, resolveComponent, withCtx, createVNode, unref, computed, mergeProps, createTextVNode } from 'file:///Users/zne/vue-projects/nuxt3-zero/node_modules/vue/index.mjs';
...
import { b as useRoute, d as useState, e as useFetch, u as useRouter, a as __nuxt_component_0$1, f as useRuntimeConfig } from './server.mjs';
import { g as getUserLikes, a as addUserLike, r as removeUserLike } from './useLike-C3EBfnqv.mjs';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        to: `/teams/${("useRoute" in _ctx ? _ctx.useRoute : unref(useRoute))().params.id}/player/` + __props.player.person.id
      }, {
  ...
  async setup(__props) {
    ...
    async function showPlayer(id) {
      ...
      const res = await Promise.all([
        useFetch(`https://statsapi.web.nhl.com/api/v1/people/${id}`, "$mY0cG4Dblf"),
        useFetch(
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(data).roster, (player2) => {
        _push(ssrRenderComponent(_component_player_card, {
          ...
          player: player2,
          likes: unref(playerLikes)[player2.person.id],
...
//# sourceMappingURL=index-DUDWhiH_.mjs.map
