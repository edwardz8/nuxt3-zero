import { eventHandler, useQuery } from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/h3/dist/index.mjs';
import { joinURL } from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/ufo/dist/index.mjs';
import { u as useRuntimeConfig } from './nitro/nitro-prerenderer.mjs';
import * as proxy from 'file:///Users/edwardz_8/vue-projects/nuxt3-zero/node_modules/unenv/runtime/mock/proxy.mjs';
...
function size(target, isReadonly = false) {
    target = target["__v_raw" /* ReactiveFlags.RAW */];
    !isReadonly && track(toRaw$1(target), "iterate" /* TrackOpTypes.ITERATE */, ITERATE_KEY);
	...
	*/
	            ...
	            : isTeleport(type)
	                ...
	                : shared.isObject(type)
	                    ...
	                    : shared.isFunction(type)
	                        ...
	                        : 0;
	    if (shapeFlag & 4 /* ShapeFlags.STATEFUL_COMPONENT */ && reactivity$1.isProxy(type)) {
	...
	function setupStatefulComponent(instance, isSSR) {
	    ...
	    if (setup) {
	        ...
	        setCurrentInstance(instance);
	        reactivity$1.pauseTracking();
	        const setupResult = callWithErrorHandling(setup, instance, 0 /* ErrorCodes.SETUP_FUNCTION */, [reactivity$1.shallowReadonly(instance.props) , setupContext]);
	        reactivity$1.resetTracking();
	        unsetCurrentInstance();
...
export { require$$0 as a, renderer$1 as b, getDefaultExportFromNamespaceIfNotNamed as g, reactivity as r, serverRenderer as s, vue_cjs_prod as v };
