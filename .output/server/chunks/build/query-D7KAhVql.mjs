import { x as withLeadingSlash, r as joinURL, y as withoutTrailingSlash, U as withBase, A as hash } from '../nitro/nitro.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-BobVsxmD.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-D7KAhVql.mjs.map
